...
function App() {
  ...
  // Sync viewport height on mobile devices when virtual keyboard opens/closes
  useEffect(() => {
  ...
  if (isCheckingAuth && !authUser) {
    return (
      <div className="fixed inset-0 h-[var(--app-height,100%)] sm:h-screen bg-[#edf2f8] flex items-center justify-center">
  ...
  return (
    <div
      ...
      className="fixed inset-0 sm:relative sm:min-h-screen sm:h-auto bg-gradient-to-br from-[#edf2f9] via-[#f1f5fa] to-[#e8eef8] flex items-center justify-center p-0 sm:p-3 md:p-6 overflow-hidden text-slate-800"
    >
